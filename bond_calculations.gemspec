...
Gem::Specification.new do |spec|
  spec.name          = "bond_calculations"
  spec.version       = BondCalculations::VERSION
  spec.authors       = ["Aldo Ruiz"]
  spec.email         = ["aldo.ruiz.luna@gmail.com"]

  spec.summary       = %q{Calculations tool for bond issues.}
